...
#pragma region Windows Form Designer generated code
			...
			void InitializeComponent(void)
			{
				...
				this->button1->Size = System::Drawing::Size(998, 92);
				...
				this->button2->Location = System::Drawing::Point(1016, 443);
				this->button2->Name = L"button2";
				this->button2->Size = System::Drawing::Size(335, 92);
				...
				this->textBox1->Location = System::Drawing::Point(316, 266);
				this->textBox1->Name = L"textBox1";
				this->textBox1->Size = System::Drawing::Size(206, 28);
				this->textBox1->TabIndex = 2;
				this->textBox1->Text = L"-7,4";
				...
				this->textBox2->Location = System::Drawing::Point(316, 307);
				this->textBox2->Name = L"textBox2";
				this->textBox2->Size = System::Drawing::Size(206, 28);
				this->textBox2->TabIndex = 3;
				this->textBox2->Text = L"0,6";
				...
				this->textBox3->Location = System::Drawing::Point(316, 348);
				this->textBox3->Name = L"textBox3";
				this->textBox3->Size = System::Drawing::Size(206, 28);
				...
				this->textBox4->Location = System::Drawing::Point(316, 391);
				this->textBox4->Name = L"textBox4";
				this->textBox4->Size = System::Drawing::Size(206, 28);
				...
				this->label1->Size = System::Drawing::Size(285, 29);
				...
				this->label2->Location = System::Drawing::Point(12, 304);
				...
				this->label3->Size = System::Drawing::Size(285, 29);
				...
				this->label4->Location = System::Drawing::Point(12, 388);
				...
				this->pictureBox1->Size = System::Drawing::Size(510, 174);
				...
				this->dataGridView1->Location = System::Drawing::Point(528, 43);
				this->dataGridView1->Name = L"dataGridView1";
				this->dataGridView1->RowHeadersVisible = false;
				this->dataGridView1->RowHeadersWidth = 51;
				this->dataGridView1->RowTemplate->Height = 24;
				this->dataGridView1->Size = System::Drawing::Size(823, 321);
				...
				this->label5->Location = System::Drawing::Point(724, 1);
				this->label5->Name = L"label5";
				this->label5->Size = System::Drawing::Size(459, 39);
				...
				this->label6->Location = System::Drawing::Point(573, 367);
				...
				this->label7->Location = System::Drawing::Point(1100, 367);
				this->label7->Name = L"label7";
				this->label7->Size = System::Drawing::Size(209, 24);
				...
				// textBox5
				// 
				this->textBox5->Location = System::Drawing::Point(528, 395);
				this->textBox5->Name = L"textBox5";
				this->textBox5->ReadOnly = true;
				this->textBox5->Size = System::Drawing::Size(306, 22);
				this->textBox5->TabIndex = 15;
				this->textBox5->TextChanged += gcnew System::EventHandler(this, &MyForm::textBox5_TextChanged);
				// 
				// textBox6
				// 
				this->textBox6->Location = System::Drawing::Point(1045, 395);
				this->textBox6->Name = L"textBox6";
				this->textBox6->ReadOnly = true;
				this->textBox6->Size = System::Drawing::Size(306, 22);
				...
				this->ClientSize = System::Drawing::Size(1363, 547);
...
#pragma endregion
		...
		private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
			...
			if ((textBox1->Text != " ") && (textBox2->Text != " ") && (textBox3->Text != " ") && (textBox4->Text != " "))
			{
				...
				while (x <= xk)
				{
					if (x <= 0)
					{
						y = cos(x * x * x + 1) / sin(x * x * x + 1);
					}
					else
						if (x <= a) { y = log((sin(x) + 1) * (sin(x) + 1)); }
						else
						{
							y = pow((2 * x * x + x * x * x * x + 1), 0.333);
						}
		...
		private: System::Void textBox3_Leave(System::Object^ sender, System::EventArgs^ e) {
			int l, t, k; bool a = true; String^ str; str = textBox3->Text; l = str->Length;
			//индекс символа, с которым работаем
			t = 0;
			//колличество запятых в строке (дабы избежать варианта 0, 2384, 1254, 1251 – это не число)
			k = 0;
